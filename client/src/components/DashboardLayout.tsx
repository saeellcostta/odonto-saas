...
const analyticsItems = [
  ...
  { icon: TrendingUp, label: "Mapa de Ganho", path: "/mapa-ganho", permission: "canViewRelatorios" as PermissionKey },
  { icon: Settings, label: "Configuração de Comissões", path: "/configuracao-comissoes", permission: "canViewRelatorios" as PermissionKey },
